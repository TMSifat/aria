...
-- CreateEnum
CREATE TYPE "UsageSource" AS ENUM ('DASHBOARD', 'API', 'WIDGET');
...
CREATE TABLE "usage_logs" (
    ...
    "userId" TEXT NOT NULL,
    "assistantId" TEXT,
    "source" "UsageSource" NOT NULL DEFAULT 'DASHBOARD',
...
-- CreateIndex
CREATE UNIQUE INDEX "assistants_widgetKey_key" ON "assistants"("widgetKey");

-- CreateIndex
CREATE INDEX "assistants_userId_idx" ON "assistants"("userId");

-- CreateIndex
CREATE INDEX "assistants_widgetKey_idx" ON "assistants"("widgetKey");

-- CreateIndex
CREATE INDEX "conversations_assistantId_idx" ON "conversations"("assistantId");
...
-- CreateIndex
CREATE INDEX "usage_logs_userId_source_idx" ON "usage_logs"("userId", "source");
